...
Agent "אמיתי" מחליט בעצמו מה הצעד הבא בכל איטרציה. כאן הזרימה ידועה מראש (מחקר, כרטיס לקול, אונבורדינג) ולכן pipeline מובנה הוא הפתרון הנכון: פשוט יותר, צפוי יותר, קל יותר להסביר ולתחזק.
