...
הנחת המוצא שלי: הלקוח הגיע עם מינימום מידע (שם, טלפון, אזור), אך קיים מידע ציבורי נרחב עליו ברשת שיכול להפוך את שיחת האונבורדינג לאפקטיבית בהרבה. המטרה היא לחסוך לעובד זאפ בזאפ את עבודת המחקר הידנית ולספק לו כרטיס לקוח מוכן לפני השיחה.
...
- העובד זאפ בזאפ זקוק למידע **מוכן לפעולה**, לא לדאמפ גולמי — לכן הפורמט מובנה ומודגשות נקודות פעולה.
...
קלט מהמשתמש (שם, טלפון, אזור, URL אופציונלי)
        ↓
סריקת URL עם BeautifulSoup (אם סופק)
        ↓
מחקר AI — Claude + חיפוש ברשת → פרופיל עסקי מובנה
        ↓
